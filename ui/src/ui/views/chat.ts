                  ...
                  (item) => html`
                    <div class="chat-queue__item">
                      ...
                      <button
                        ...
                        type="button"
                        aria-label="${t("chat.queue.removeItem")}"
        ...
        <div class="chat-compose__row">
          ...
          <div class="chat-compose__actions">
            ...
            <button
              ...
              @click=${props.onSend}
            >
              ${isBusy ? t("chat.queue.title") : t("chat.send")}<kbd class="btn-kbd">↵</kbd>
            </button>
          </div>
        </div>
      </div>
...
function buildChatItems(props: ChatProps): Array<ChatItem | MessageGroup> {
  ...
  if (historyStart > 0) {
    items.push({
      ...
      message: {
        role: "system",
        content: t("chat.history.truncated", { limit: String(CHAT_HISTORY_RENDER_LIMIT), hidden: String(historyStart) }),
        timestamp: Date.now(),
      },
    });
  }
